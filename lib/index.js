...
var Events = require('events'),
    ...
    goodMagicMixin = clan.mixin({
        // We need delegate sine good reporters wont stop listening to events
        // and will always stay active even after calling their stop method.
        // So we pass the reporter our own emitter and make sure we clear all of
        // its events after stopping the reporter.
        // This should be changed if reporters will have proper stop methods
